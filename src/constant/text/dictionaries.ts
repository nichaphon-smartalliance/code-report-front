...
const th = {
  ...
  "reports.new.branch.load": "โหลดรายการ branch",
  "reports.new.branch.loading": "กำลังโหลดรายการ branch",
  "reports.new.branch.select": "เลือก branch",
  "reports.new.branch.locked": "โหลดรายการ branch ให้สำเร็จก่อน จึงจะกรอกส่วนที่เหลือได้",
  "reports.new.branch.empty": "repository นี้ยังไม่มี branch จึงสร้างรายงานไม่ได้",
  ...
  "reports.new.period.preset.today": "วันนี้",
  "reports.new.period.preset.last7": "7 วันล่าสุด",
  "reports.new.period.preset.last30": "30 วันล่าสุด",

  "reports.new.section.filters": "ตัวกรอง",
  "reports.new.branch": "Branch",
  "reports.new.author": "ผู้เขียนคอมมิต",
  "reports.new.author.everyone": "ทุกคน",
  "reports.new.author.load": "โหลดรายชื่อผู้เขียนคอมมิต",
  "reports.new.author.loading": "กำลังโหลดรายชื่อ",
  "reports.new.author.empty": "ไม่พบผู้เขียนคอมมิตในช่วงเวลานี้",
...
const en: Record<MessageKey, string> = {
  ...
  "reports.new.branch.load": "Load branches",
  "reports.new.branch.loading": "Loading branches",
  "reports.new.branch.select": "Choose a branch",
  "reports.new.branch.locked": "Load the branch list before filling in the rest.",
  "reports.new.branch.empty": "This repository has no branches, so no report can be made.",
  ...
  "reports.new.period.preset.today": "Today",
  "reports.new.period.preset.last7": "Last 7 days",
  "reports.new.period.preset.last30": "Last 30 days",

  "reports.new.section.filters": "Filters",
  "reports.new.branch": "Branch",
  "reports.new.author": "Commit author",
  "reports.new.author.everyone": "Everyone",
  "reports.new.author.load": "Load committers",
  "reports.new.author.loading": "Loading committers",
  "reports.new.author.empty": "Nobody committed in this period.",
